...
int main() {
    ...
    scanf_s("%s", firstString, (unsigned)sizeof(firstString));
    printf("Enter the second string: ");
    char secondString[100] = {'\0'};
    scanf_s("%s", secondString, (unsigned)sizeof(secondString));
    ...
    printf("the number of occurrences of the second string in the first string as substrings is %d", count);
    return 0;
}
